...
[2,8,3,3,4,30,0.2,None],
[2,8,3,3,5,30,0.2,None],
[2,8,3,3,6,30,0.2,None],
[2,8,3,3,7,30,0.2,None],
[2,8,3,3,8,30,0.2,None],
[2, 8, 3, 3, 9, 30, 0.2, None],
[2, 8, 3, 3, 10, 30, 0.2, None],
[2, 8, 3, 3, 11, 30, 0.2, None],
[2, 8, 3, 3,12, 30, 0.2, None],# 1

[3,8,4,4,3,30,0.2,None],
[3,8,4,4,4,30,0.2,None],
[3,8,4,4,5,30,0.2,None],
[3,8,4,4,6,30,0.2,None],
[3,8,4,4,7,30,0.2,None],
[3,8,4,4,8,30,0.2,None],
[3,8,4,4,9,30,0.2,None],
[3,8,4,4,10,30,0.2,None],
[3,8,4,4,11,30,0.2,None],
[3,8,4,4,12,30,0.2,None],#2

[4,8,5,5,3,30,0.2,None],
[4,8,5,5,4,30,0.2,None],
[4,8,5,5,5,30,0.2,None],
[4,8,5,5,6,30,0.2,None],
[4,8,5,5,7,30,0.2,None],
[4,8,5,5,8,30,0.2,None],
[4,8,5,5,9,30,0.2,None],
[4,8,5,5,10,30,0.2,None],
[4,8,5,5,11,30,0.2,None],
[4,8,5,5,12,30,0.2,None],#3

[5,8,6,6,3,30,0.2,None],
[5,8,6,6,4,30,0.2,None],
[5,8,6,6,5,30,0.2,None],
[5,8,6,6,6,30,0.2,None],
[5,8,6,6,7,30,0.2,None],
[5,8,6,6,8,30,0.2,None],
[5,8,6,6,9,30,0.2,None],
[5,8,6,6,10,30,0.2,None],
[5,8,6,6,11,30,0.2,None],
[5,8,6,6,12,30,0.2,None],#4

[6,8,7,7,3,30,0.2,None],
[6,8,7,7,4,30,0.2,None],
[6,8,7,7,5,30,0.2,None],
[6,8,7,7,6,30,0.2,None],
[6,8,7,7,7,30,0.2,None],
[6,8,7,7,8,30,0.2,None],
[6,8,7,7,9,30,0.2,None],
[6,8,7,7,10,30,0.2,None],
[6,8,7,7,11,30,0.2,None],
[6,8,7,7,12,30,0.2,None],#5
    ]
...
for i in range(len(small_Instance_Mairx)):
    ...
    savepath = "D:\PythonProjet\SF-learning\多深紧致化RMFS中机器人的任务调度\数值实验\数值实验5_机器人数量.xls"
    book.save(savepath)
