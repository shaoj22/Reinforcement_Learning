...
[2, 8, 3, 15, 5, 30, 0.2, None],
[2, 8, 4, 11, 5, 30, 0.2, None],
[2, 8, 5, 9, 5, 30, 0.2, None],
[2, 8, 6, 7, 5, 30, 0.2, None],
[2, 8, 7, 6, 5, 30, 0.2, None],
[2, 8, 9, 5, 5, 30, 0.2, None],
[2, 8, 11, 4, 5, 30, 0.2, None],
[2, 8, 15, 3, 5, 30, 0.2, None],


[3, 8, 3, 15, 5, 30, 0.2, None],
[3, 8, 4, 11, 5, 30, 0.2, None],
[3, 8, 5, 9, 5, 30, 0.2, None],
[3, 8, 6, 7, 5, 30, 0.2, None],
[3, 8, 7, 6, 5, 30, 0.2, None],
[3, 8, 9, 5, 5, 30, 0.2, None],
[3, 8, 11, 4, 5, 30, 0.2, None],
[3, 8, 15, 3, 5, 30, 0.2, None],

[4, 8, 3, 15, 5, 30, 0.2, None],
[4, 8, 4, 11, 5, 30, 0.2, None],
[4, 8, 5, 9, 5, 30, 0.2, None],
[4, 8, 6, 7, 5, 30, 0.2, None],
[4, 8, 7, 6, 5, 30, 0.2, None],
[4, 8, 9, 5, 5, 30, 0.2, None],
[4, 8, 11, 4, 5, 30, 0.2, None],
[4, 8, 15, 3, 5, 30, 0.2, None],

[5, 8, 3, 15, 5, 30, 0.2, None],
[5, 8, 4, 11, 5, 30, 0.2, None],
[5, 8, 5, 9, 5, 30, 0.2, None],
[5, 8, 6, 7, 5, 30, 0.2, None],
[5, 8, 7, 6, 5, 30, 0.2, None],
[5, 8, 9, 5, 5, 30, 0.2, None],
[5, 8, 11, 4, 5, 30, 0.2, None],
[5, 8, 15, 3, 5, 30, 0.2, None],

[6, 8, 3, 15, 5, 30, 0.2, None],
[6, 8, 4, 11, 5, 30, 0.2, None],
[6, 8, 5, 9, 5, 30, 0.2, None],
[6, 8, 6, 7, 5, 30, 0.2, None],
[6, 8, 7, 6, 5, 30, 0.2, None],
[6, 8, 9, 5, 5, 30, 0.2, None],
[6, 8, 11, 4, 5, 30, 0.2, None],
[6, 8, 15, 3, 5, 30, 0.2, None],
                        ]
...
for i in range(len(small_Instance_Mairx)):
    ...
    savepath = "D:\PythonProjet\SF-learning\多深紧致化RMFS中机器人的任务调度\数值实验\数值实验6_m&n.xls"
    book.save(savepath)
