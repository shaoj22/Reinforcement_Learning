...
Date: 2024-02-21 20:23:49
LastEditors: shaoj22 935619774@qq.com
LastEditTime: 2024-02-22 11:23:14
FilePath: \Reinforcement_Learning\Base_Algorithm\Base_Part_3\mbpo.py
Description: model based policy optimization code
'''
...
class MBPO:
    ...
    def explore(self):
        ...
        while not done:
            action = self.agent.take_action(obs)
            next_obs, reward, done, t, _ = self.env.step(action)
            done = done or t 
