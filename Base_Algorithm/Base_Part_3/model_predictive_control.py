...
Date: 2024-02-21 20:23:21
LastEditors: shaoj22 935619774@qq.com
LastEditTime: 2024-02-22 10:54:43
FilePath: \Reinforcement_Learning\Base_Algorithm\Base_Part_3\model_predictive_control.py
Description: MPC code
'''
...
class PETS:
    ...
    def mpc(self):
        ...
        while not done:
            ...
            next_obs, reward, done, t, _ = self._env.step(action)
            done = done or t
