...
Date: 2024-02-21 08:42:41
LastEditors: shaoj22 935619774@qq.com
LastEditTime: 2024-02-21 13:58:06
FilePath: \Reinforcement_Learning\Base_Algorithm\dqn.py
Description: dqn algorithm code
'''
...
class DQN:
    ...
    def update(self, transition_dict):
        ...
        #     if len(state) == 2:
        #         transition_dict['states'][i] = transition_dict['states'][i][0]
